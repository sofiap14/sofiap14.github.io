...
export default function NavBar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      } else if (offset < educationSection - 200) {
  ...
  return (
    <div className="h-[4.5rem] w-full sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full text-gray-300 text-sm">
      <nav className="text-xs sm:top-6 fixed top-0 left-1/2 transform -translate-x-1/2 p-5 mt-3 h-10 flex justify-center items-center bg-opacity-80 border border-pastel-purpledeep rounded-full border-opacity-40 shadow-lg shadow-black/[0.01] backdrop-blur-[0.5rem] dark:bg-pastel-purpledeep dark:bg-opacity-75">
