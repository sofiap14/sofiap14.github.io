...
export default function Languages() {
  ...
  <section>
      ...
      >
        ...
        <div className="grid grid-cols-3 gap-4 max-w-sm mx-7 md:max-w-md md:mx-24 md:grid md:grid-cols-3 md:gap-18 lg:max-w-lg lg:mx-52 mt-6 lg:grid lg:grid-cols-3 lg:gap-15">
