  ...
  return (
    <section id="skills">
      <div className="container pb-28" data-aos="zoom-in">
        ...
        <ul className="md:flex md:flex-wrap md:justify-center md:space-x-9 lg:p-28 lg:flex lg:flex-wrap lg:justify-center lg:space-x-9 text-center grid grid-cols-3 p-6 gap-x-4 gap-y-14 lg:grid-cols-7 lg:gap-x-1 lg:gap-y-20 text-gray-200 font-mono text-sm place-items-baseline">
