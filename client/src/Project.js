...
export default function Project({ title, imageSrc, description, techStack, demoLink, codeLink, liveLink }) {
  ...
  return (
    <div className="project-row items-center md:px-4 lg:pl-16" data-aos="fade-up">
      ...
      {/* Project Right */}
      <div className="flex flex-col space-y-2 pb-8 project-right md:place-content-center md:w-3/5 lg:w-3/5 md:text-lg lg:text-sm md:ml-0 lg:ml-0 xl:ml-0 md:order-2 lg:order-2">
