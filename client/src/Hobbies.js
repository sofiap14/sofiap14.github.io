...
export default function Hobbies() {
  ...
  <section>
    <div className="mt-10 mb-6 font-mono" id="hobbies">
      ...
      <div className="mt-6">
        <ul className="grid grid-cols-2 gap-4 text-xs md:text-md lg:text-sm text-gray-400 font-mono justify-items-center">
          <li style={{ whiteSpace: 'nowrap' }} className=" text-gray-400 flex items-center"> Petting my cat <FaCat className='ml-2 text-gray-300' /></li>
